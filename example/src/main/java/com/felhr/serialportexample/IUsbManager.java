...
public interface IUsbManager extends android.os.IInterface
{
    ...
    public static abstract class Stub extends android.os.Binder implements com.felhr.serialportexample.IUsbManager
    {
         ...
         */
        public static com.felhr.serialportexample.IUsbManager asInterface( android.os.IBinder obj )
        {
            throw new RuntimeException( "Stub!" );
        }
